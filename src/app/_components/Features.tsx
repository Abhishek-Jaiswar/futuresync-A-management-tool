...
const Features = () => {
  return (
    <div className='flex flex-col md:flex-row items-center md:items-start justify-between lg:gap-28 md:gap-10 gap-5 p-4 lg:p-8'>
      <div className='w-full md:w-1/2 md:sticky md:top-[15rem] md:left-0 flex flex-col items-center md:items-start'>
